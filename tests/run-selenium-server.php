...
$seleniumURL = 'http://selenium-release.storage.googleapis.com/2.53/selenium-server-standalone-2.53.0.jar';
...
file_put_contents($thisPath.$batFile, "java -jar {$thisPath}{$seleniumBase}");
